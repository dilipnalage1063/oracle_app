  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text('Core HR Services',
                      ...
                      Row(
                        children: [
                          const Icon(Icons.search,
                              color: Color(0xFF1F4E8C), size: 20),
                          ...
                          if (!isSmallScreen) ...[
                            TextButton(
                              ...
                              child: const Text('Advanced',
                                  style: TextStyle(
                                      color: Color(0xFF1F4E8C), fontSize: 12)),
                            ),
                            const SizedBox(width: 8),
                            TextButton(
                              onPressed: () {},
                              child: const Text('Saved Search',
                                  style: TextStyle(
                                      color: Color(0xFF1F4E8C), fontSize: 12)),
                            ),
                            const SizedBox(width: 8),
                          ...
                          children: [
                            Expanded(
                              child: TextButton(
                                ...
                                child: const Text('Advanced',
                                    style: TextStyle(
                                        color: Color(0xFF1F4E8C), fontSize: 11)),
                              ),
                            ),
                            const SizedBox(width: 8),
                            Expanded(
                          ...
                          children: [
                            OutlinedButton(
                              ...
                              style: OutlinedButton.styleFrom(
                                foregroundColor: const Color(0xFF1F4E8C),
                                side:
                                    const BorderSide(color: Color(0xFF1F4E8C)),
                                padding: const EdgeInsets.symmetric(
                              ...
                              child: DataTable(
                                ...
                                rows: _searchResults
                                    .map(
                                      (result) => DataRow(
                                        cells: [
                                          // ── NAME as hyperlink → EmployeeDetailScreen ──
                                          DataCell(
                                            GestureDetector(
