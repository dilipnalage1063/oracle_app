    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            const Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(height: 4),
                                  Text('Action: Add nonworker',
                                      style: TextStyle(
                                          fontSize: 11,
                                          color: Color(0xFF6B7280))),
                                  Text('Action Reason: Creation of Non-Worker',
                                      style: TextStyle(
                                          fontSize: 11,
                                          color: Color(0xFF6B7280))),
                                ],
                        ...
                        const Text('Effective Start Date: 1/1/22 (1 of 1)',
                            style: TextStyle(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: const Text('Active - Payroll Eligible',
                              style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 11,
                                  fontWeight: FontWeight.w600)),
            ...
            const SizedBox(height: 10),
            const _ExpandRow(
                title: 'Manager Details', subtitle: 'No data to display'),
            const SizedBox(height: 10),
            ...
            const _ExpandRow(
                title: 'PAR Remarks', subtitle: 'No data to display'),
            const SizedBox(height: 10),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(
              icon: Icon(Icons.people), label: 'Directory'),
          BottomNavigationBarItem(
